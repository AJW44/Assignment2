...
// any of the Boxes in the board grid are Player.Empty. If they are, it is not a

// draw.

// Hint: Return false if it is not a draw, return true if there are not empty
...
* Return true if the turn player has won after making their move at the
...
if (board[currentRow][0].content == player && board[currentRow][1].content == player
...
if (board[0][currentCol].content == player && board[1][currentCol].content == player
